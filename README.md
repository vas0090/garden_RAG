...
## User Guide: 
What you will need:
- An API Key from QDrant: Create a QDrant account: https://qdrant.tech/ and make a cluster --> you can use either the cloud-based version or using your local with docker, but we used cloud-based.
